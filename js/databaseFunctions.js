...
dbRef.on("value", snap =>
{
  ...
  /*console.log(workouts[0].exercises[0].duration);
  ...
  $("#exerciseConfirm").click(function()
  {
    ...
    //console.log(localStorage.theDuration);
    //console.log(localStorage.theBreak);
  });
  ...
  $("#feedbackConfirm").click(function()
  {
    ...
    //firebaseRef.child("strength").child(0).push(strength);
    //firebaseRef.child("cardio").child(0).push(cardio);
  });
